...
su sesión. Un origen CORS permitido **no es autenticación**: un cliente HTTP puede
falsificar `Origin`. Antes de publicar, añadir controles de abuso/costos (por
ejemplo Cloud Armor y cuotas), revisar el límite real de las subidas firmadas y
